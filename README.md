...
To get docker running, follow the docker installation guide for your system ([insert link here](https://docs.docker.com/desktop/install/mac-install/)). Once installed and tested, run "docker-compose up" in your terminal/command line and the jekyll website will launch on localhost:4000.
